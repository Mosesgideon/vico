                    ...
                    child: BlocConsumer<BankBloc, BankState>(
                      ...
                      builder: (context, state) {
                        if(state is BankAccountLoaingState){
                          return Center(child: TextView(text: "Fetching bank account...",color: Colors.grey,),);
                        }
                        ...
                        if(state is BankAccountSuccessState){
                          ...
                          return DropdownButton2<String>(
                            ...
                            items: accounts?.map<DropdownMenuItem<String>>((account) {
                              final displayText = "${account.bank} - ${account.number}";
                              final value = account.id.toString();

                              return DropdownMenuItem<String>(
                                value: value,
                                child: TextView(text: displayText, fontSize: 16,color: Colors.white,),
                              );
                            }).toList(),
                            ...
                            iconStyleData: const IconStyleData(
                              icon: Icon(
                                  Iconsax.arrow_down_1, color: Pallets.grey75),
                            ),
                          );
                        }
                        return SizedBox();
